...
UB = {"t0": 3, "t1": 4, "t2": 4}  # upper bound of term's value
...
if __name__ == "__main__":
    testIndex = {}
    testIndex["t0"] = [1, 3, 5, 2, LAST_ID]
    testIndex["t1"] = [1, 2, 3, 6, LAST_ID]
    testIndex["t2"] = [1, 2, 3, 6, LAST_ID]

    w = WAND(testIndex)
    final_result = w.perform_query(["t0", "t1", "t2"])
    print("=================final result=======================")
